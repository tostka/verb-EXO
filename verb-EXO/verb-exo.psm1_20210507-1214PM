...
Function test-xoMailbox {
    ...
    REVISIONS
    # 12:06 PM 5/6/2021 swapped out 'Fail' msgtrace expansion, and have it do all non-Delivery statuses, up to the $MsgTraceNonDeliverDetailsLimit = 10; tested, appears functional
...
"@
                ...
                # EXO MAILBOX
                $pltTxmc=@{identity=$Mailbox ; } ;
                if($script:useEXOv2){$mapiTest = Test-xoMAPIConnectivity @pltTxmc ; }
                else { $mapiTest = Test-exoMAPIConnectivity @pltTxmc ;} ;
                $FixText = @"
========================================
...
# CisGAQQBgjcCAQsxDjAMBgorBgEEAYI3AgEVMCMGCSqGSIb3DQEJBDEWBBTCTD+d
# 5F5AXqIznSMCf1oKBvVE8TANBgkqhkiG9w0BAQEFAASBgDCDo4WuVPkNuJVNutD6
# oryZKST7o8fdbrnTT88tnws2L3zSN5lz3m96GdMn0zCfmxmYbtdZ/iWgMckgWCXi
# SIerIKHTIC42DE/iW07rcXSuKEbrgbDhcB/iGlDvegxFi/J1NHKLPDEvHnKLTyIR
# rUV1NuYEQYFG5xitXjj8yOZq
