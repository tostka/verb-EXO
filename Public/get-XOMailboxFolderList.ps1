#*------v Function get-XOMailboxFolderList v------
    if(-not (get-command get-XOMailboxFolderList -ea 0)){
        function get-XOMailboxFolderList {
	        ...
	        * 6/15/22 vm posted version
            ...
            PARAM(
                [Parameter(Position = 0,Mandatory=$true, ValueFromPipeline=$true, HelpMessage="Smtp Address of mailbx to be processed")]
                    $SMTPAddress
            )
